...
dect = tree.DecisionTreeClassifier(max_depth=9, random_state=2)
dect.fit(X, y)

benchmark(dect, X_train, X_test, y_train, y_test, 'DecisionTree')
drawPlots(dect, X_train, X_test, y_train, y_test, 'DecisionTree')

for ii in range(9,0,-1):
    dect = tree.DecisionTreeClassifier(max_depth=ii, random_state=2)
    dect.fit(X, y)
    title = 'DecisionTree maxdepth='+str(ii)
    benchmark(dect, X_train, X_test, y_train, y_test, title)
    # drawPlots(dect, X_train, X_test, y_train, y_test, 'DecisionTree maxdepth=',ii)
